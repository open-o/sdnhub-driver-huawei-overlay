...
public class ITWanInterfaceFailTest extends TestManager {

    WanInterfaceDriverSuccessServer wanServer = new WanInterfaceDriverSuccessServer();
    ...
    public void testQueryFail() throws ServiceException {
        File createFile = new File("src/integration-test/resources/overlayvpndriver/queryWanInterfaceFail.json");
