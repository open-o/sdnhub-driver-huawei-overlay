...
public class PolicyRouteSuccessServer extends MocoHttpServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(PolicyRouteSuccessServer.class);

    public PolicyRouteSuccessServer() {
        super();
    }
