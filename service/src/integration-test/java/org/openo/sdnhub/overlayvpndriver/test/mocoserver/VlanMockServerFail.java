...
public class VlanMockServerFail extends MocoHttpServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(VlanMockServerFail.class);

    public VlanMockServerFail() {
        super();
    }
    ...
    public void addRequestResponsePairs() {
        ...
        this.addRequestResponsePair("src/integration-test/resources/overlayvpndriver/moco/vlanDeleteFail.json",
                new SubnetSuccessResponseHandler());
    ...
    private class SubnetSuccessResponseHandler extends MocoResponseHandler {
        ...
        public void processRequestandResponse(HttpRquestResponse httpObject) {
            ...
            ACResponse<List<EthInterfaceConfig>> inputInstanceList = JsonUtil.fromJson(httpResponse.getData(), new TypeReference<ACResponse<List<EthInterfaceConfig>>>() {});

            ResultRsp<ACResponse<List<EthInterfaceConfig>>> newResult = new ResultRsp<ACResponse<List<EthInterfaceConfig>>>(ErrorCode.OVERLAYVPN_SUCCESS);
