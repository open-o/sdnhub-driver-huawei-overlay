...
public class SubnetBDIfMockServerFail extends MocoHttpServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(SubnetBDIfMockServerFail.class);

    public SubnetBDIfMockServerFail() {
        super();
    }
