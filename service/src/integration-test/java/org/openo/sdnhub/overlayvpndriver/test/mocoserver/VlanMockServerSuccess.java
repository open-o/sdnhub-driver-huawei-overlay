...
public class VlanMockServerSuccess extends MocoHttpServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(VlanMockServerSuccess.class);

    public VlanMockServerSuccess() {
        super();
    }
