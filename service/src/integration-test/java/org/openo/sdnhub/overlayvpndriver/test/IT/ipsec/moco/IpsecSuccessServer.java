...
public class IpsecSuccessServer extends MocoHttpServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(IpsecSuccessServer.class);

    public IpsecSuccessServer() {
        super();
    }
