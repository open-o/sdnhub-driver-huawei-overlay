...
public class LocalSNatMockServerFail extends MocoHttpServer {

    private static final Logger LOGGER = LoggerFactory.getLogger(LocalSNatMockServerFail.class);

    public LocalSNatMockServerFail() {
        super();
    }
