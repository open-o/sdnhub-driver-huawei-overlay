...
public class SubnetMockServerHttps extends MocoHttpsServer{
    ...
    public void addRequestResponsePairs()  {
        ...
        this.addRequestResponsePair("src/integration-test/resources/overlayvpndriver/moco/subnetDeleteSuccess.json",
                new MocoResponseHandler());
        this.addRequestResponsePair("src/integration-test/resources/overlayvpndriver/moco/subnetUpdateSuccess.json",
                new MocoResponseHandler());
