...
package org.openo.sdno.overlayvpndriver.util.convertmodel;
...
import org.openo.sdno.overlayvpndriver.model.ipsec.adapter.NetIke;
import org.openo.sdno.overlayvpndriver.model.ipsec.adapter.NetIpSec;
...
import org.openo.sdno.overlayvpndriver.model.ipsec.adapter.NetRule;
...
public class IpSecModelConvert {
    ...
    private static NetIke buildNetIke(final NeIpSecConnection ipSecNeConnection, String peerIp)
        ...
        NetIke netIke = new NetIke(ipSecNeConnection.getIkePolicy().getAuthAlgorithm(),
                ipSecNeConnection.getIkePolicy().getEncryptionAlgorithm(), null, peerIp, ipSecNeConnection.getPsk());
