 ...
 */
public class AcBranchProxy implements IAcBranchProxy{
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AcBranchProxy.class);

    private static volatile AcBranchProxy uniqueInstance = null;

    private AcBranchProxy() {
    }
     ...
     * @since SDNO 0.5
     */
    public static synchronized AcBranchProxy getInstance() {
        if(null == uniqueInstance) {
            uniqueInstance = new AcBranchProxy();
        }
    ...
    public HTTPReturnMessage sendGetMsg(String url, String body, String ctlrUuid) {
        AcBranchSsoProxy acSSOLogin = createACSSOProxy(ctlrUuid);
        if(null == acSSOLogin) {
    ...
    private AcBranchSsoProxy createACSSOProxy(String ctlrUuid) {
        ...
        AcBranchSsoProxy acSSOLogin = null;
        ...
        acSSOLogin = AcBranchSsoProxy.getInstance(controllerIp, comm.getPort(), authInfo.getUserName(),
