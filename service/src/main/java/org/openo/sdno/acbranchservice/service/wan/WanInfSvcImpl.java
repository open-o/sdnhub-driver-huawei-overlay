...
import org.openo.sdno.acbranchservice.model.wan.NetWanSubInterfaceIp;
...
public class WanInfSvcImpl {
    ...
    private static ResultRsp<List<WanSubInterface>> queryWanSubIf(String ctrlUuid, String deviceId)
        ...
        HTTPReturnMessage httpMsg = AcBranchProxy.getInstance().sendGetMsg(url, null, ctrlUuid);
    ...
    private static void enableDhcp(String ctrlUuid, String deviceId, String type) throws ServiceException {
        ...
        HTTPReturnMessage httpMsg = AcBranchProxy.getInstance().sendPutMsg(url, JsonUtil.toJson(updateIpMap), ctrlUuid);
