 ...
 */
public class AcBranchSsoProxy {

    private static final String SSLCONTEST_TLS = "TLSV1.2";

    private static final String APPLICATION_JSON = "application/json";

    private static final Logger LOGGER = LoggerFactory.getLogger(AcBranchSsoProxy.class);
    ...
    private static Map<String, AcBranchSsoProxy> instanceCache = new HashMap<String, AcBranchSsoProxy>();

    private AcBranchSsoProxy(final String acIp, final String acPort, final String acLoginName, String acLoginPassword) {
        this.acIp = acIp;
        this.acPort = acPort;
     ...
     * @return the AcBranchSsoProxy instance
     * @since SDNO 0.5
     */
    public static AcBranchSsoProxy getInstance(final String acIp, final String acPort, final String acLoginName,
        ...
        synchronized(instanceCache) {
            ...
            if(instanceCache.get(acSsoProxyUniqueId) != null) {
                ...
                AcBranchSsoProxy proxy = new AcBranchSsoProxy(acIp, acPort, acLoginName, acLoginPassword);
    ...
    private static AcBranchResponse parserAcResponse(String content) {
        ...
        return JsonUtil.fromJson(respoenJO.toString(), AcBranchResponse.class);
    }
    ...
    public String toString() {
        return "AcBranchSsoProxy [acIp=" + acIp + ", acPort=" + acPort + ", acLoginName=" + acLoginName + "]";
    }
}
