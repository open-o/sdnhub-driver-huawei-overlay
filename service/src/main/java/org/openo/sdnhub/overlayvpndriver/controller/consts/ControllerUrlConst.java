...
public class ControllerUrlConst {
    ...
    public static final String CREATE_NETWORK_BY_DEVICEID_URL = QUERY_NETWORK_BY_DEVICEID_URL;

    public static final String DELETE_NETWORK_BY_DEVICEID_URL = QUERY_NETWORK_BY_DEVICEID_URL;
    ...
    public static final String DELETE_POLICYROUTE_URL = CREATE_POLICYROUTE_URL;

    public static final String UPDATE_POLICYROUTE_URL = CREATE_POLICYROUTE_URL;

    public static final String QUERY_POLICYROUTE_URL = CREATE_POLICYROUTE_URL;
