...
public class SubnetBDIfROAResourceTest {
    ...
    String jsonbody = "{\"errcode\": \"0\",\"errmsg\": \"\",\"data\": [{\"id\": "
            + "\"db12e63b259444eda12c96a42fe47e56\",\"name\": \"ipseconn\",\"interfaceName\": \"GigabitEthernet0/0/1\",\"ipsecConnection\": [{\"seqNumber\": 1,\"deleteMode\": false,\"type\": true,\"routeInject\": \"dynamic\",\"ipsec\": {\"name\": \"proposal1\",\"espAuthAlgorithm\": \"md5\",\"espEncryptionAlgorithm\": \"3des\"},\"ike\": {\"id\": 1,\"authAlgorithm\": \"sha1\",\"encryptionAlgorithm\": \"des\",\"version\": \"v2\",\"localAddress\": null,\"peerAddress\": null,\"preSharedKey\": \"huawei\"},\"aclNumber\": null,\"aclId\": null,\"ruleList\": null},{\"seqNumber\": 2,\"deleteMode\": false,\"type\": false,\"routeInject\": null,\"ipsec\": {\"name\": \"proposal2\",\"espAuthAlgorithm\": \"md5\",\"espEncryptionAlgorithm\": \"3des\"},\"ike\": {\"id\": 2,\"authAlgorithm\": \"sha1\",\"encryptionAlgorithm\": \"des\",\"version\": \"v2\",\"localAddress\": null,\"peerAddress\": \"33.33.33.33\",\"preSharedKey\": \"huawei\"},\"aclNumber\": 3000,\"aclId\": \"bfd2e7ab23be41fbb9955d4baf3686bc\",\"ruleList\": [{\"id\": 0,\"policy\": \"permit\",\"srcIp\": \"1.1.1.1\",\"srcNetMask\": \"255.255.255.0\",\"desIp\": \"2.2.2.2\",\"desNetMask\": \"255.255.255.0\"}]}]}]}";
    @Test
    public void testQueryBDIfSuccess() throws ServiceException {
        ...
        new MockUp<SvcExcptUtil>() {
           @Mock
           public void throwBadRequestException(java.lang.String msg) throws org.openo.baseservice.remoteservice.exception.ServiceException{

           }
        };
        ResultRsp<SbiSubnetBdInfoModel> expected=subnetbdiroaresource.queryBDIf(request, deviceId , vni , ctrlUuidParam );
