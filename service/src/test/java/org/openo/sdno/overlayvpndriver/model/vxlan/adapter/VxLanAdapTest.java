...
import org.openo.sdno.overlayvpndriver.model.vxlan.adapter.NetPortVlan;
import org.openo.sdno.overlayvpndriver.model.vxlan.adapter.NetVni;
...
public class VxLanAdapTest {
	...
	public void NetVniTest() {
		 ...
		 * netPortVlan = new NetPortVlan(); portvlanlist.add(10);
		 * obj.setPortvlanlist(vlanList); assertEquals("RTImport",
		 * obj.getPortvlanlist());
		 */
	}
